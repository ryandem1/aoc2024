...
func TestAllDays(t *testing.T) {
	testCases := []struct {
		...
		{
			name:          "Day4Part1Example",
			puzzleFunc:      Day4Part1,
			puzzleInputName: "day4example",
			correctAnswer: "18",
		},
		{
			name:          "Day4Part2Example",
			puzzleFunc:      Day4Part2,
			puzzleInputName: "day4example",
			correctAnswer: "9",
		},
		{
			name:          "Day5Part1Example",
			puzzleFunc:      Day5Part1,
			puzzleInputName: "day5example",
			correctAnswer: "153",
		},
		{
			name:          "Day5Part2Example",
			puzzleFunc:      Day5Part2,
			puzzleInputName: "day5example",
			correctAnswer: "153",
		},
	}
